## Project contents
  ...
  - This project implements continuous integration and continuous deployment of a Docker container. It includes both projects 4 and 5 used to achieve these goals.
	...
	- Project 5 Continuous Deployment allows us to implement Continous deployment of a docker container using webhooks via dockerhub and github
	  - [Project 5 README-CD.md](Project5/README-CD.md)
